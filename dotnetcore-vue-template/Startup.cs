using Autofac;
using guepardoapps.dotnetcore_vue_template.Adapter;
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                {
                    Version = "v1",
                    Title = ".Net Core Vue Template API v1",
                    ...
                    {
                        Name = "MIT",
                        Url = new Uri("https://github.com/JonasSchubert/dotnetcore-vue-template/blob/master/LICENSE"),
                    }
                });
            });
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IComponentContext componentContext)
        {
            if (env.IsDevelopment())
            {
                ...
                app.UseSwaggerUI(c =>
                {
                    c.SwaggerEndpoint("/swagger/v1/swagger.json", "i18n Service API v1");
